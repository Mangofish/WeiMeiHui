...
- (void)showInViewControllerTwo:(UIViewController *)viewController{
    ...
    [self showShareSheetViewTwo:viewController];
...
- (void)showShareSheetView:(UIViewController *)viewController
{
    ...
    LWShareSheetView *shareSheetView = [LWShareSheetView shareSheetViewWithType:1];
...
//    CGFloat height = [LWShareSheetView sectionCount] == 2?314:([LWShareSheetView sectionCount] == 1?220:106);
    CGFloat height = 205;
    self.sheetView.frame = CGRectMake(20, [UIScreen mainScreen].bounds.size.height, [UIScreen mainScreen].bounds.size.width-40, height);
...
- (void)showShareSheetViewTwo:(UIViewController *)viewController{
    ...
    LWShareSheetView *shareSheetView = [LWShareSheetView shareSheetViewWithType:2];
    
    [viewController.view.window addSubview:shareSheetView];
    self.sheetView = shareSheetView;
//    [self.sheetView buildUI];
    //    CGFloat height = [LWShareSheetView sectionCount] == 2?314:([LWShareSheetView sectionCount] == 1?220:106);
    CGFloat height = 205;
    self.sheetView.frame = CGRectMake(20, [UIScreen mainScreen].bounds.size.height, [UIScreen mainScreen].bounds.size.width-40, height);
    CGRect frame = self.sheetView.frame;
