...
#define kItemWidth (SCREEN_W - kMargin * 2 -kMinimumInteritemSpacing*4 - 40) / 4.
#define kItemHeight 85
...
//    [cell.shareBtn setTitle:item[kShareTitle] forState:UIControlStateNormal];
    ...
    if (menus.count == self.bottomMenus.count ) {
        cell.shareBtn.tag = 4+indexPath.item;
    }
...
//    [];
    self.shareBtnClickBlock(sender.tag);
}
