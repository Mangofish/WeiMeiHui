...
{
    _pageLabel.text = [NSString stringWithFormat:@"%ld/%ld", (long)pageNum, (long)allPageNum];
...
//    _pageLabel.frame = CGRectMake((self.bounds.size.width - _pageLabel.bounds.size.width) / 2, (self.bounds.size.height - _pageLabel.bounds.size.height) / 2, _pageLabel.bounds.size.width, _pageLabel.bounds.size.height);
    _pageLabel.frame = CGRectMake((self.bounds.size.width - _pageLabel.bounds.size.width) / 2, SafeAreaHeight, _pageLabel.bounds.size.width, _pageLabel.bounds.size.height);
}
