...
- (void)setProgressText:(NSString *)progressText{
    ...
    _score = [[UILabel alloc]initWithFrame:self.bounds];
    _score.textColor = [UIColor whiteColor];
    _score.text = progressText;
    _score.font = [UIFont systemFontOfSize:10];
    _score.textAlignment = NSTextAlignmentCenter;
    [self addSubview:_score];
    [self bringSubviewToFront:_score];
    
}

- (void)setPercentText:(NSString *)percentText{
    
    _percentLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 145, 15)];
    _percentLab.textColor = [UIColor whiteColor];
    _percentLab.text = percentText;
    _percentLab.font = [UIFont systemFontOfSize:10];
    _percentLab.textAlignment = NSTextAlignmentRight;
    [self addSubview:_percentLab];
    [self bringSubviewToFront:_percentLab];
