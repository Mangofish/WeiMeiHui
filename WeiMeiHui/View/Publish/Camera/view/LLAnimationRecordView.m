...
@interface LLAnimationRecordView()<CAAnimationDelegate>
...
@implementation LLAnimationRecordView
...
- (void)addCircleLayer
{
    ...
    self.arcLayer.strokeColor = [UIColor colorWithHexString:@"32be78"].CGColor;
