...
//        UIButton*tag = [UIButton buttonWithType:0];
        ...
        tag.textColor =MJRefreshColor(102, 102, 102);
...
//        tag.layer.borderColor = [[UIColor colorWithWhite:0.895 alpha:1.000] CGColor];
        ...
        CGSize textStrSize = [textStr sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15]}];
