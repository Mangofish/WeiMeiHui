...
- (void)configWithType:(EaseBlankPageType)blankPageType hasTitle:(NSString *)title hasImageName:(NSString *)imgName hasData:(BOOL)hasData hasError:(BOOL)hasError reloadButtonBlock:(void(^)(id sender))block;
@end
