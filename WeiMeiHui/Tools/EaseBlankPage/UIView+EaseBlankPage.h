...
- (void)configBlankPage:(EaseBlankPageType)blankPageType hasTitles:(NSString *)title hasImageNames:(NSString *)imgName hasData:(BOOL)hasData hasError:(BOOL)hasError reloadButtonBlock:(void(^)(id sender))block;
