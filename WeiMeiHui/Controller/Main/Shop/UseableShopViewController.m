...
@interface UseableShopViewController ()<UITableViewDelegate,UITableViewDataSource,JSDropDownMenuDelegate,JSDropDownMenuDataSource>
{
...
@implementation UseableShopViewController
...
- (void)getData{
    ...
    [YYNet POST:CardShop paramters:@{@"json":url} success:^(id responseObject) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.authorSingle = [ShopAndAuthor shopAuthorWithDict:self.dataAry[indexPath.section]];
...
- (void)addSelectedView{
    ...
    if (!_menu) {
        ...
        _menu = [[JSDropDownMenu alloc] initWithOrigin:CGPointMake(0, SafeAreaHeight+1) andHeight:44];
