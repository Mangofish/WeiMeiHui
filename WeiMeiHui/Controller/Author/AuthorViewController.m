...
@interface AuthorViewController ()<UITableViewDelegate,UITableViewDataSource,HWDownSelectedViewDelegate>
{
    NSUInteger page;
...
- (void)configUI{
    ...
    [_textBg mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.titleView.mas_left).offset(Space);
    ...
    _mainTableView.frame = CGRectMake(0, SafeAreaTopHeight+88, kWidth, kHeight-SafeAreaTopHeight-88-SafeAreaBottomHeight);
...
- (void)addDownView{
    ...
    [downv mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_equalTo(kWidth/4);
        make.height.mas_equalTo(40);
        make.left.mas_equalTo(self.down1.mas_right).offset(0);
        make.top.mas_equalTo(self.line.mas_bottom).offset(0);
    }];
    downv.delegate = self;
    downv.tag = 2;
    ...
    [downV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_equalTo(kWidth/4);
        make.height.mas_equalTo(40);
        make.left.mas_equalTo(self.down2.mas_right).offset(0);
        make.top.mas_equalTo(self.line.mas_bottom).offset(0);
    }];
    downV.delegate = self;
    downV.tag = 3;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        ALLAuthorsTableViewCell *cell =  cell = [ALLAuthorsTableViewCell allAuthorsTableViewCellSecond];
...
//  智能排序
    ...
    if (selectedView.tag == 4) {
        ...
        filtrate = [self.filtrateAry[indexPath.row] objectForKey:@"id"];
