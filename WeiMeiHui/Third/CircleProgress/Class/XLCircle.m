...
-(void)buildLayout
{
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[[UIColor whiteColor] CGColor],(id)[[UIColor whiteColor] CGColor],nil]];
    ...
    _endPoint.frame = CGRectMake(0, 0, 2 - endPointMargin*2,2 - endPointMargin*2);
